...
namespace CopyFilesWithExceptionHandling
{
    /// <summary>
    ...
    public partial class MainWindow : Window
    {
        ...
        private void CopyFilesFromDir(string sourceDir, string destinationDirRoot, string logsDirName)
        {
            ...
            foreach (string file in fileList)
            {
                ...
                {
                    string errorLogfileName = System.IO.Path.Combine(logsDirName, sourceDirNameOnly + "_errors.txt");
                    File.AppendAllText(errorLogfileName, System.IO.Path.GetFileName(file) + Environment.NewLine);
                }
            }
